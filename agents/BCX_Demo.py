...
BidDuration = 15 #Time in seconds for which bid is active
SwitchOffDuration = 30 #Time in seconds for which appliances should be off
BidSwitchingDelay = 10 # Time in seconds between Bid end and Switch off 
...
User_OffDuration_List = [30, #User1
                  20, #User2
                  30, #User3
                  50, #User4
                  20, #User5
...
#    SelectedIndex.sort()
    ...
    #%% Replace with actual Data --------------------------------------------
        if i == 0:    
            ...
            Flag = False
        User_List[i].logUsageData(Watt = User_List[i].Watt,UsgId = UsgId,Flag = False)
    #%%-------------------------------------------------------------------------
    print("\n") 
...
#    print("SMART CONTRACT INFORMED FOR CLOSING AUCTION".center(TerminalSize,"-"))
    ...
    subprocess.call(['bash', 'offtest.sh'])        
    print("\n")
    ...
    subprocess.call(['bash', 'ontest.sh'])
...
xmark1 = User_List[0].DataAuction[0][0]-User_List[0].DataTime[0]
xmark2 = User_List[0].DataAuction[0][1]-User_List[0].DataTime[0]
xmark3 = User_List[0].DataAuction[0][2]

trace2 = go.Scatter(
    x=[xmark1,xmark1,xmark2,xmark2],
    y=[0,100,100,0],
    fill='tozeroy', 
    fillcolor='rgba(26,35,230,0.1)',
    mode='none'
)

#trace3 = go.Scatter(
#    x=[xmark1,xmark1,xmark1+xmark3,xmark1+xmark3],
#    y=[0,100,100,0],
#    fill='tozeroy', 
#    fillcolor='rgba(126,135,230,0.1)',
#    mode='none'
#)
