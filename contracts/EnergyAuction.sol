...
contract EnergyAuction {
    ...
    event PledgeSuccessful(bytes32 indexed _auctionId, uint256 _totalSavedWatt, uint256 _totalPayout);
    ...
    function createAuction(bytes32 _auctionId, uint256 _totalIncentive, uint256 _wattHourGoalSavings,
